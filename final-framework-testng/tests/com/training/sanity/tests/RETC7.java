...
public class RETC7 {
	...
	public void validLoginTest() {
		...
		newlaunchPOM.sendyourname("amala");
		newlaunchPOM.sendyouremail("amalamallavarapu@gmail.com");
		//newlaunchPOM.scrolldown();
		newlaunchPOM.sendyoursubject("apartments");
		newlaunchPOM.sendyourmessage("looking for apartments");
		newlaunchPOM.clickonsend();
		screenShot.captureScreenShot("Enquiry");
		String expected="Thank you for your message. It has been sent";
		String actual= newlaunchPOM.getenquirymessage();

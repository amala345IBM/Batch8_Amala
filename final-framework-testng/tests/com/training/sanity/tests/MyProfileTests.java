...
public class MyProfileTests {
	...
	private MyProfilePOM myprofilePOM;
	...
	public void setUp() throws Exception {
		...
		myprofilePOM= new MyProfilePOM(driver);
	...
	public void validLoginTest() {
		...
		//myprofilePOM.clickUserHyperLink();
		screenShot.captureScreenShot("myprofile");
		
		myprofilePOM.clickLogOutLink();
		screenShot.captureScreenShot("AfterLogout");
	}
}
